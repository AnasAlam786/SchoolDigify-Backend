...
cancel_tc_api_bp = Blueprint('cancel_tc_api_bp', __name__)


@cancel_tc_api_bp.route('/api/cancel-tc', methods=['POST'])
@login_required
...
def cancel_tc():
    ...
    try:
        ...
        return jsonify({"error": "Session information is invalid. Please login again."}), 400
